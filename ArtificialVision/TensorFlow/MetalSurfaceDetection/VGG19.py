...
entreno=ruta2+"/VGG19/Normalizado_Mask02/train"
testeo=ruta2+"/VGG19/Normalizado_Mask02/test"
val=ruta2+"/VGG19/Normalizado_Mask02/val"
...
n_tratamiento=3
"""
c1=cv2.imread(ruta2+img_crazing_train[1])
c2=cv2.imread(ruta2+img_noDefect_train[1])
c3=cv2.imread(ruta2+img_inclusion_train[13])
c4=cv2.imread(ruta2+img_patches_train[10])
c5=cv2.imread(ruta2+img_pitted_train[10])
c6=cv2.imread(ruta2+img_rolled_train[12])
c7=cv2.imread(ruta2+img_scratches_train[11])
"""

#to_plot = [c1, c2, c3, c4, c5, c6, c7, c7]

fig, axes = plt.subplots(nrows=2, ncols=4,figsize=(10, 8), subplot_kw={'xticks': [], 'yticks': []})
fig.subplots_adjust(hspace=0.05, wspace=0.05)
for ax, i in zip(axes.flat, to_plot):
    ax.imshow(i, cmap='gray')
plt.tight_layout()
...
for i in range(len(img_noDefect_train)):
  cargar_img(ruta2+img_noDefect_train[i],n_tratamiento)

c1=cargar_img(ruta2+img_crazing_train[1],n_tratamiento)
c2=cargar_img(ruta2+img_noDefect_train[1],n_tratamiento)
c3=cargar_img(ruta2+img_inclusion_train[13],n_tratamiento)
c4=cargar_img(ruta2+img_patches_train[10],n_tratamiento)
c5=cargar_img(ruta2+img_pitted_train[10],n_tratamiento)
c6=cargar_img(ruta2+img_rolled_train[12],n_tratamiento)
c7=cargar_img(ruta2+img_scratches_train[11],n_tratamiento)

"""
n_tratamiento=4
c1=cargar_img("01.bmp",n_tratamiento)
c2=cargar_img("02.png",n_tratamiento)
c3=cargar_img("03.bmp",n_tratamiento)
c4=cargar_img("04.bmp",n_tratamiento)
c5=cargar_img("05.bmp",n_tratamiento)
c6=cargar_img("06.bmp",n_tratamiento)
c7=cargar_img("07.bmp",n_tratamiento)
"""
to_plot = [c1, c2, c3, c4, c5, c6, c7, c7]
fig, axes = plt.subplots(nrows=2, ncols=4,figsize=(10, 8), subplot_kw={'xticks': [], 'yticks': []})
fig.subplots_adjust(hspace=0.05, wspace=0.05)
...
for i in range(len(img_crazing_train)):
  ...
  plt.imsave(entreno+img_crazing_train[i], img, cmap='gray')            
...
for i in range(len(img_crazing_resto)):
  ...
  if i<=max:
    ...
    plt.imsave(testeo+img_crazing_train[i], img, cmap='gray') 
  else:
    #cv2.imwrite(val+img_crazing_train[i],img)
    plt.imsave(val+img_crazing_train[i], img, cmap='gray')     
...
for i in range(len(img_noDefect_train)):
  ...
  plt.imsave(entreno+img_noDefect_train[i], img, cmap='gray')     
...
for i in range(len(img_noDefect_resto)):
  ...
  if i<=max:
    ...
    plt.imsave(testeo+img_noDefect_train[i], img, cmap='gray')
  else:
    #cv2.imwrite(val+img_noDefect_train[i],img)
    plt.imsave(val+img_noDefect_train[i], img, cmap='gray')  
...
for i in range(len(img_inclusion_train)):
  ...
  plt.imsave(entreno+img_inclusion_train[i], img, cmap='gray')
...
for i in range(len(img_inclusion_resto)):
  ...
  if i<=max:
    ...
    plt.imsave(testeo+img_inclusion_train[i], img, cmap='gray')
  else:
    #cv2.imwrite(val+img_inclusion_train[i],img)  
    plt.imsave(val+img_inclusion_train[i], img, cmap='gray')
...
for i in range(len(img_patches_train)):
  ...
  plt.imsave(entreno+img_patches_train[i], img, cmap='gray')
...
for i in range(len(img_patches_resto)):
  ...
  if i<=max:
    ...
    plt.imsave(testeo+img_patches_train[i], img, cmap='gray')
  else:
    #cv2.imwrite(val+img_patches_train[i],img)  
    plt.imsave(val+img_patches_train[i], img, cmap='gray')
...
for i in range(len(img_pitted_train)):
  ...
  plt.imsave(entreno+img_pitted_train[i], img, cmap='gray')
...
for i in range(len(img_pitted_resto)):
  ...
  if i<=max:
    ...
    plt.imsave(testeo+img_pitted_train[i], img, cmap='gray')
  else:
    #cv2.imwrite(val+img_pitted_train[i],img)  
    plt.imsave(val+img_pitted_train[i], img, cmap='gray')
...
for i in range(len(img_rolled_train)):
  ...
  plt.imsave(entreno+img_rolled_train[i], img, cmap='gray')
...
for i in range(len(img_rolled_resto)):
  img=cargar_img(ruta2+img_rolled_train[i],n_tratamiento)
  if i<=max:
    plt.imsave(testeo+img_rolled_train[i], img, cmap='gray')
  else:
    plt.imsave(val+img_rolled_train[i], img, cmap='gray')
...
for i in range(len(img_scratches_train)):
  ...
  plt.imsave(entreno+img_scratches_train[i], img, cmap='gray')            
...
for i in range(len(img_scratches_resto)):
  ...
  if i<=max:
    ...
    plt.imsave(testeo+img_scratches_train[i], img, cmap='gray')
  else:
    #cv2.imwrite(val+img_scratches_train[i],img)
    plt.imsave(val+img_scratches_train[i], img, cmap='gray')  
...
overfitCallback = EarlyStopping(monitor='loss', min_delta=0, patience = 3)

checkpoint_filepath = ruta2+'/VGG19/modelos'
...
fit_history=model.fit_generator(train_generator,steps_per_epoch=steps_per_epoch_train, epochs=number_epoch, verbose=1, validation_data=validation_generator, validation_steps=steps_per_epoch_val,callbacks=[overfitCallback,checkpoint_model])


ruta_pesos=ruta2+'/VGG19/modelos/VGG19_Normalizado_Mask02.h5'
model.save(ruta_pesos)
...
#score = model.evaluate_generator(validation_generator, steps_per_epoch_val, verbose=1)
#checkpoint_model.best=score
