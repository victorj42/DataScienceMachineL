...
entreno=ruta2+"/Xception/Normalizado/train"
testeo=ruta2+"/Xception/Normalizado/test"
val=ruta2+"/Xception/Normalizado/val"
...
checkpoint_filepath = ruta2+'/Xception/modelos'
...
fit_history=model.fit_generator(train_generator,steps_per_epoch=steps_per_epoch_train, epochs=number_epoch, verbose=1, validation_data=validation_generator, validation_steps=steps_per_epoch_val,callbacks=[overfitCallback,model_checkpoint_callback])


ruta_pesos=ruta2+'/Xception/modelos/Xception_Normalizado_01.h5'
...
#cp1 = tf.keras.callbacks.ModelCheckpoint(checkpoint_filepath, monitor='loss', verbose=1, save_best_only=True, mode='min')
