...
%cat data.yaml
"""
# yolov5s.yaml  -- aqui se ve la configuracion inicial de yolo
%cat /content/yolov5/models/yolov5s.yaml

#Para ver si tienes los cambios
...
%cd /content/yolov5/
!python detect.py --weights '/content/yolov5/runs/train/exp/weights/best.pt' --img 244 --conf 0.8 --source '/content/drive/My Drive/DataSets/Memoria_02/REY_DATASET/REY_scan_anonim/test'
