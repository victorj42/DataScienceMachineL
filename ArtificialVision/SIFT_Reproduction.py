# -*- coding: utf-8 -*-
"""
Created on Wed Jul  6 17:38:51 2022
...
img=cv.imread("rey_modelo.png",0)
comienzo = time.time()
ptos_clave,_ = computeKeypointsAndDescriptors(img)
final = time.time()
print(final-comienzo)
imageP = cv.drawKeypoints(img, ptos_clave, None)
cv.imshow("Prueba", imageP)
cv.waitKey(0)
